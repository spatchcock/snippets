...
#
# Source: https://gist.github.com/jpmckinney/3040303
#         https://gist.github.com/anonymous/5125422
#
module ActiveAdmin
  module Views
    module Pages
      class Index
        def render_blank_slate
          ...
          if controller.action_methods.include?('new') && can?(:create, Object.const_get(active_admin_config.resource_label))
